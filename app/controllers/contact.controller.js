...
/* exports.create = (req, res) => {
    res.send({ messafe: "create handler"});
};

exports.fildAll = (req, res) => {
    res.send({ message: "findAll handler"});
};

exports.fildOne = (req, res) => {
...
exports.fildAllFavorite = (req, res) => {
...
exports.findOne = async (req, res, next) => {
    try {
        ...
        return next (
            new ApiError(500, `Error while retrieving contact with id ${req.params.id}`)
        );
    }
};
...
exports.delete = async (req, res, next) => {
    try {
        ...
        return next(new ApiError(500, "Could not be delete contact with id=${req.params.id}"));
    }
};
